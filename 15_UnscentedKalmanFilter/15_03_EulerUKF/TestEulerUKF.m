%****************************************************************
% Modul			  : TestEulerUKF.m                              *
%				                            					*
% Datum           : 02-Dez-2013                                 *
%                                                               *
% Funktion        : Startfunktion der Schätzung der Lagewinkel  *
%                   eines Helikopters mittels UKF               *
%                                                               *
...
for k=1:nSamples
  ...
  [phi_a theta_a] = EulerAccel(ax, ay); % Beschl. in Eulerwinkel umrechnen

  [phi theta psi] = EulerUKF([phi_a theta_a]', [p q r], dt); % UKF
